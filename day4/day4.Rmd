...
**All models are specified as reference indicator models, but can also be specified as fixed factor models at any time**
...
Now we want to test the confogural measurement model.
